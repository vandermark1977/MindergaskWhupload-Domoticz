...
return {
	active = true,
	on = {
		timer 			= {'at 0:12'},       --Tijdstip waarop meterstand naar mindergas gaat
		--timer 			= {'every minute'},
	...
	execute = function(domoticz, item)
        ...
        if item.isTimer then
			...
			local kWhUsageCounter 	= domoticz.devices(145).WhTotal/1000  -- Verbruiksmeter van de wamtepomp
			...
			domoticz.openURL({
				url = 'https://www.mindergas.nl/api/meter_readings',        -- Nieuwe URL van mindegas.nl
				method = 'POST',
				headers = {
